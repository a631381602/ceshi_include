...
# Scrapy settings for ceshi_include project
#
...
BOT_NAME = 'ceshi_include'

SPIDER_MODULES = ['ceshi_include.spiders']
NEWSPIDER_MODULE = 'ceshi_include.spiders'
...
DOWNLOADER_MIDDLEWARES = {
	...
	'ceshi_include.middlewares.RandomUserAgent': 1,
...
ITEM_PIPELINES = {
    'ceshi_include.pipelines.CeshiIncludePipeline': 300,
    'ceshi_include.pipelines.MySQLCeshiIncludePipeline': 400,
}
